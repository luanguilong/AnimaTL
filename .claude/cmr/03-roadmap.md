...
| T9 | **打磨杂项批** | vcam 真视锥 wireframe、CameraPath 独立显隐、预览黑边按输出宽高比自适应 | 打磨 | 无需 spec | ✅ 2026-07-24 三项全落地(视锥 LineHandleAdornment 随 FOV 重建;轨迹显隐偏好持久化;黑边按 2.35:1 动态)——效果待 Studio 实测 |
